 ...
 * @author caarl
 */
public class CarteleraClienteView extends javax.swing.JFrame {

    /**
     * Creates new form CarteleraClienteView
     */
    public CarteleraClienteView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnVrRFunciones.setText("ver funciones");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarteleraClienteView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarteleraClienteView().setVisible(true);
            }
        });
    }
