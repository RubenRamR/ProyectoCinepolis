 ...
 * @author caarl
 */
public class frmCrudPelicula extends javax.swing.JFrame {

    /**
     * Creates new form CarteleraClienteView
     */
    public frmCrudPelicula() {
        initComponents();
    }
    ...
    private void cargarConfiguracionInicialTablaPeliculas() {
        ...
        modeloColumnas = this.tblCatalogo.getColumnModel();
    ...
    private void editar() {
        frmEditarPeliculaAdm pel = new frmEditarPeliculaAdm();
    ...
    private void initComponents() {
        ...
        btnVrRSucursales = new javax.swing.JButton();
        cmbxCiudad = new javax.swing.JComboBox<>();
        LblCiudadbox = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();
        TxtArSinopsis = new javax.swing.JScrollPane();
        ...
        cmbxGenero.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        cmbxClasificacion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jLabel9.setText("Películas disponibles. Seleccione una.");
        ...
        tblCatalogo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Título", "Género", "Clasificación", "Sinopsis", "Duración", "País de Origen", "Tráiler", "Editar", "Eliminar"
            }
        ) {
        ...
        btnVrRSucursales.setBackground(new java.awt.Color(255, 255, 51));
        btnVrRSucursales.setText("Ver sucursales");
        btnVrRSucursales.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVrRSucursalesActionPerformed(evt);
            }
        });

        cmbxCiudad.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        LblCiudadbox.setText("Ciudad");

        jLabel3.setText("Sinopsis:");

        TxtASinopsis.setColumns(20);
        TxtASinopsis.setRows(5);
        TxtArSinopsis.setViewportView(TxtASinopsis);

        jLabel4.setText("Link del trailer:");
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(LblCiudadbox)
                                        .addGap(38, 38, 38)
                                        .addComponent(jLabel6)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(jLabel7)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 16, Short.MAX_VALUE)
                                        .addComponent(btnVrRSucursales))
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addGap(0, 0, Short.MAX_VALUE))))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(TxtArSinopsis, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(TxtLink, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(TxtArSinopsis, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(jLabel9))
    ...
    private void btnVrRSucursalesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVrRSucursalesActionPerformed
        // Crea una nueva instancia del formulario frmCompraBoletos
        frmCrudSucursal sucursal = new frmCrudSucursal();
        ...
        this.setVisible(false);
    }//GEN-LAST:event_btnVrRSucursalesActionPerformed

    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        CarteleraAdminView men = new CarteleraAdminView();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
        frmEditarPeliculaAdm edit = new frmEditarPeliculaAdm();
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(frmCrudPelicula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCrudPelicula().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel LblCiudadbox;
    private javax.swing.JTextArea TxtASinopsis;
    private javax.swing.JScrollPane TxtArSinopsis;
    private javax.swing.JTextField TxtLink;
    private javax.swing.JButton btnAyuda;
    private javax.swing.JButton btnEditar;
    private javax.swing.JButton btnGuardar;
    private javax.swing.JButton btnVolver;
    private javax.swing.JButton btnVrRSucursales;
